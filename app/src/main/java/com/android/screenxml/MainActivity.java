 ...
 * 这里填写UI效果图的屏幕高度, 这里填写你需要支持的屏幕分辨率字符串,如果需要支持负数则填写true反之false);
 */
public class MainActivity extends AppCompatActivity {
    ...
    private String supportDimensions = "1920x1080,2094x1080,2220x1080,1280x720,2030x1080,2560x1440," +
            ...
            "2200x1080,2032x1080,2733x1440,2646x1440,2454x1600,1396x720,2316x1080,1368x720";
    ...
    /**
     * 1.首先点击按钮生成xml文件
     * 2.然后在手机本地文件夹中找到res目录
     * 3.把手机本地res目录下的文件全部拷贝到项目中的res文件中即可
     */
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = this;
        // 点击生成屏幕适配的XML文件，记得给手机SD卡读写文件的权限
        findViewById(R.id.btnClick).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("TAG", "分辨率总数量：" + supportDimensions.split(",").length);
                if (mMarkTask == null) {
    ...
    private class MarkTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
             ...
             */
            // 例如，我们公司的UI设计师是在360*640分辨率上做效果图，则传入相对应的分辨率尺寸
            com.wyq.markXml.MarkXmlUtil.markXmlFile(mContext, 360, 640, supportDimensions, true);
            /**
